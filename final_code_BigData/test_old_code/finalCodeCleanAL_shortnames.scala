...
object finalCodeCleanAL {
  ...
  def loadAndCleanData(spark: SparkSession): DataFrame = {
    ...
    //drop not needed columns and edit long column names
    filteredInputDF2.printSchema()
    filteredInputDF2.createOrReplaceTempView("cancer_data")
    val filteredInputDF3 = spark.sql("""
